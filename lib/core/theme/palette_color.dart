...
/// An enhanced [MaterialColor] that includes shade 25 and typed convenience getters.
///
/// Fully compatible wherever a [Color], [ColorSwatch], or [MaterialColor] is expected.
class PaletteColor extends MaterialColor {
  const PaletteColor(super.primary, super.swatch);

  /// Factory constructor to construct a [PaletteColor] with all standard shade weights.
  factory PaletteColor.fromShades({
    ...
    return PaletteColor(primaryValue, {
      25: shade25,
      50: shade50,
      100: shade100,
      200: shade200,
  ...
  /// Extra light tint shade (25)
  Color get shade25 => this[25] ?? shade50;
}
